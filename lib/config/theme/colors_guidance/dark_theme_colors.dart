...
class DarkThemeColors {
  ...
  static const primaryFixedDim = Color(0xFFD0BCFF);
  ...
  static const surfaceContainerHightest = Color(0xFF36343B);
  static const surfaceContainerHight = Color(0xFF2B2930);
